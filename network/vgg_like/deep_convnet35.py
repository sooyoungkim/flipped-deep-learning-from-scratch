...
class DeepConvNet:
    ...
    def __init__(self, input_dim=(1, 28, 28),  # 입력데이터 차원 수
                 ...
                 # 16 * ((28 + 2*1 - 3)/1 + 1) * = 16 * 28 * 28 -> pooling 적용 -> 16 * ((28 - 2)/2 + 1) *  = 16 * 14 * 14
                 # 32 * 14 * 14
                 # 32 * ((14 + 2*2 - 3)/1 + 1) * = 32 * 16 * 16 -> pooling 적용 -> 32 * ((16 - 2)/2 + 1) * = 32 * 8 * 8
                 # 64 * 8 * 8
        ...
        # # 초기 매개변수 보관
        self.save_params("fashion_mnist_init_params.pkl")
        ...
        self.layers['Dropout6'] = Dropout(dropout_ratio=0.3)
