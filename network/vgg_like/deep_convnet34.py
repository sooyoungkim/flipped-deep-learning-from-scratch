...
class DeepConvNet:
    ...
    def __init__(self, input_dim=(1, 28, 28),  # 입력데이터 차원 수
        ...
        # self.params['gamma1'] = np.ones(25088)  # 1
        # self.params['beta1'] = np.zeros(25088)  # 0
        ...
        # 원본 그대로에서 시작하는 것으로 초기화. 1배 확대(gamma), 이동 0(beta)
        # self.params['gamma3'] = np.ones(12544)  # 1
        # self.params['beta3'] = np.zeros(12544)  # 0
        ...
        # 원본 그대로에서 시작하는 것으로 초기화. 1배 확대(gamma), 이동 0(beta)
        # self.params['gamma5'] = np.ones(8192)  # 1
        # self.params['beta5'] = np.zeros(8192)  # 0
        ...
        self.layers['Dropout7'] = Dropout(dropout_ratio=0.5)
    ...
    def gradient(self, x, t):
        ...
        for idx1 in range(1, self.conv_layer_num + 1):
            ...
            # if idx1 % 2 != 0:
            #     grads['gamma' + str(idx1)] = self.layers['BatchNorm' + str(idx1)].dgamma
            #     grads['beta' + str(idx1)] = self.layers['BatchNorm' + str(idx1)].dbeta
