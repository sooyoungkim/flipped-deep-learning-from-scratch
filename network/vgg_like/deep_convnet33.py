...
class DeepConvNet:
    ...
    네트워크 구성은 아래와 같음 no.3.3
        conv - batchNorm - relu - conv - relu - pool -
        conv - batchNorm - relu - conv - relu - pool -
        conv - batchNorm - relu - conv - relu - pool -
    ...
    def __init__(self, input_dim=(1, 28, 28),  # 입력데이터 차원 수
                 ...
                 # 64 * 14 * 14 -> 모두 곱하면 12544
                 # 64 * ((14 + 2*2 - 3)/1 + 1) * = 64 * 16 * 16 -> pooling 적용하면 -> 64 * ((16 - 2)/2 + 1) * = 64 * 8 * 8
                 # 128 * 8 * 8  -> 모두 곱하면 8192
                 # 128 * 8 * 8 -> pooling 적용하면 -> 128 * ((8 - 2)/2 + 1) * = 128 * 4 * 4
                 ...
                 conv_param_4={'filter_num': 64, 'filter_size': 3, 'pad': 2, 'stride': 1},
