...
class TwoLayerNet:
    ...
    def numerical_gradient(self, x, t):
        ...
        grads = {}
        grads['W1'] = gradient.numerical_gradient(loss_W, self.params['W1'])    # loss_W(self.params['W1']) 미분
        ...
        #
        print("grads['W1'] : ".format(grads['W1']))
        print("self.params['W1'] : ".format(self.params['W1']))
